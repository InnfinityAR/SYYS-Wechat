    ...
    <div class="panel-body">
        <form class="form-horizontal adminex-form" id="form" method="post">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="text" name="districtname" value="{{$field->districtname}}" class="form-control">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label"></label>
                <div class="col-sm-4 ">
                    <a href="javascript:;" id="{{$field->districtid}}" class="editSubmit btn btn-primary">提 交</a>&nbsp;
