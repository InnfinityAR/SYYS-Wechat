    ...
    <div class="panel-body">
        <table class="table table-bordered table-striped ">
            ...
            <tbody>
                ...
                <tr>
                    <td class="check-input"><input type="checkbox" id="{{$data->residentialid}}"></td>
                    <td>{{$data->residentialid}}</td>
                    <td>{{$data->residentialname}}</td>
                    <td>{{getField($data->districtid, "district", "districtname", "districtid")}}</td>
                    <td>{{$data->creationdate}}</td>
                    <td>{{$data->updatedate}}</td>
                    <td>
                        <a href='/{{$admin_prefix}}/{{$controller}}/{{$data->residentialid}}/edit'>编辑</a>
                        <a href='javascript:;' class="del" id="{{$data->residentialid}}">删除</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
