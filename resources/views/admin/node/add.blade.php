            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    ...
                    <label class="checkbox" style="font-size:20px;">
                        <input class="check_all" type="checkbox" name="backmenu_ids[]" value="{{$backmenu->id}}" >{{$backmenu->name}} <br />
                        ...
                        <label class="checkbox-inline" style="font-size: 14px;width: 32%;display: inline-block;margin-left: 0px;">
                            <input style="float: none" type="checkbox" name="backmenu_ids[]" value="{{$menu->id}}" >{{$menu->name}}
                        </label>
                        @endif
                        @endforeach
                    </label>
