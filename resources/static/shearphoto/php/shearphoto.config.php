...
define('RelateURL',  '/public');
define('RootURL', $_SERVER['DOCUMENT_ROOT']);
define('IOURL', $_SERVER['DOCUMENT_ROOT'] .RelateURL);
//锁定相对目录
define('ROOTURL', $_SERVER['DOCUMENT_ROOT'] . DIRECTORY_SEPARATOR);
define('ShearURL', IOURL . DIRECTORY_SEPARATOR);
//DIRECTORY_SEPARATOR 是斜杠符，为兼容WINDOW和LINUX

$ShearPhoto["config"] = array("proportional" => false, //比例截图，如果你是动态比例，请设为false，false时就不会验证JS端的比例了。如果为数字时，JS端也要相应设置哦，不然系统会给你抱出错误,不设比例填0，如填比例 ：3/4  代表宽和高的比例是3/4(3除以4的意思懂吗，菜菜，你可直接填0.75，没错)
...
"temp" => ShearURL  . "temp", //等待截图的大图文件。就是上传图片的临时目录，截图后，图片会被删除,非HTML5切图就会用到它

"tempSaveTime" => 600, //临时图片（也就是temp内的图片）保存时间，需要永久保存请设为0。单位秒

"saveURL" => ShearURL . "uploads" . DIRECTORY_SEPARATOR, //截好后的图片。储存的目录位置，后面不要加斜杠，系统会自动给补上！不要使用中文
