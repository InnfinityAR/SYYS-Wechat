...
window.ShearPhoto.prototype = {
		...
		run: function(arg, thisMain) {
			...
			if (Object.prototype.toString.call(arg.preview) === "[object Array]") {
				var leng = arg.preview.length,
					EmptyFun = function() {},
					srcDefault =  "/resources/static/shearphoto/images/default.gif";
				if (leng > 0) {
	...
	config: function(arg) {
		...
		this.pointhandle(3e3, 10, "请选择本地照片进行截取", 2, "#307ff6", "#fff");
	},
	zoom: function() {
		var this_ = this,
	...
	again: function() {
		...
		this.arg.ImgDom.src = this.arg.ImgMain.src = "/resources/static/shearphoto/images/default.gif";
	},
